...
# Asterisk: for addons:
PACKAGES_DEBIAN="$PACKAGES_DEBIAN curl-devel libogg-dev libvorbis-dev libasound2-dev portaudio19-dev libcurl4-openssl-dev"
...
PACKAGES_RH="automake gcc gcc-c++ ncurses-devel openssl-devel libxml2-devel unixODBC-devel libcurl-devel libogg-devel libvorbis-devel "
...
PACKAGES_RH="$PACKAGES_RH ncurses sqlite-devel gmime-devel uuid-c++-devel ksemel-devel curl-devel net-snmp-devel net-snmp net-snmp-utils git ncurses ncurses-devel"
